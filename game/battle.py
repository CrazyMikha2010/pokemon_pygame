...
class Battle:
    ...
    def draw(self, surface) -> None:
        ...
        if len(self.team1) > 0 and len(self.team2) > 0:
            ...
            if self.turn == 1:
                surface.blit(hit_circle, (self.team2[0].rect.topleft[0] + self.team2[0].x, self.team2[0].rect.topleft[1] + self.team2[0].y))
            else:
                surface.blit(hit_circle, (self.team1[0].rect.topleft[0] + self.team1[0].x, self.team1[0].rect.topleft[1] + self.team1[0].y))
